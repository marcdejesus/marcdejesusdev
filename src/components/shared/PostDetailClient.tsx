...
interface PostDetailClientProps {
  post: UpdatePost;
  backUrl: string; // e.g., "/blog" or "/updates"
  backText: string; // e.g., "Back to Blog" or "Back to Updates"
  imageHint?: string; // Custom data-ai-hint
}

export function PostDetailClient({ post, backUrl, backText, imageHint }: PostDetailClientProps) {
    ...
    >
      ...
      <motion.div variants={itemVariants} className="mb-10 relative w-full aspect-[16/7] rounded-xl overflow-hidden shadow-lg">
        <Image
          ...
          data-ai-hint={imageHint || post.dataAiHint || "post cover image"}
        />
      </motion.div>
