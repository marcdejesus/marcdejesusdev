...
const Footer = () => {
  ...
  const openGitHub = () => {
    window.open('https://github.com/marcdejesus', '_blank');
  };

  const openLinkedIn = () => {
    window.open('https://linkedin.com/in/marcdejesus', '_blank');
  };
    ...
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          >
            <button className="social-link github" onClick={openGitHub}>
            ...
            <button className="social-link linkedin" onClick={openLinkedIn}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="footer-bottom">
        ...
        >
          <p className="copyright">
            © {currentYear} Marc De Jesus. All rights reserved.
          </p>
